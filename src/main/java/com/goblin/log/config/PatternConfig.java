...
public class PatternConfig {
     ...
     * 通用key-value正则匹配
     */
    public static Pattern COMMON_KV_PATTERN = Pattern.compile("(?i)(password|passwd|pwd|secret|token|Authorization|session|clientSecret)\"{0,1}\\s*[:|=]\\s*\"{0,1}[a-zA-Z0-9\\@\\_\\-]+\"{0,1}");
}
